...
#    input:
#        table_alt = "facets/calling/somatic_cnv_gene_calls_filtered/{tsample}_Vs_unmatchedNormal.tsv.gz",
...
rule somatic_cna_oncokb:
    input:
        table_alt = "facets/calling/somatic_cnv_gene_calls_filtered/{tsample}_Vs_unmatchedNormal.tsv.gz",
        table_cln = "tumor_normal_pairs.tsv",
        table_gen = metaprism_config["params"]["oncokb"]["gene_list"],
        rules = metaprism_config["params"]["oncokb"]["rules_clean"],
        script_path = "workflow/scripts/oncokb_annotate.sh"
    output:
        table_alt_pre = temp("oncokb/annotation/somatic_cna_oncokb/{tsample}_Vs_unmatchedNormal_alt_pre.tsv"),
        table_cln_pre = temp("oncokb/annotation/somatic_cna_oncokb/{tsample}_Vs_unmatchedNormal_cln_pre.tsv"),
        table_run = temp("oncokb/annotation/somatic_cna_oncokb/{tsample}_Vs_unmatchedNormal_run.tsv"),
        table_pos = "oncokb/annotation/somatic_cna_oncokb/{tsample}_Vs_unmatchedNormal.tsv",
    log:
        "logs/annotation/somatic_cna_oncokb/{tsample}_Vs_unmatchedNormal.log"
    # conda:
        # "/mnt/beegfs/pipelines/MetaPRISM_WES_Pipeline/workflow/envs/python.yaml"
        # "metaprism_py"
    params:
