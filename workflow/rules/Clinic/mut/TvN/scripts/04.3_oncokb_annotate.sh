...
python -u workflow/rules/Clinic/Mut_Annotation/TvN/scripts/04.1_oncokb_preprocess.py \
    --table_alt ${table_alt} \
    --table_cln ${table_cln} \
    --table_gen ${table_gen} \
...
python -u workflow/rules/Clinic/Mut_Annotation/TvN/scripts/04.2_oncokb_postprocess.py \
    --input ${table_run} \
    --rules ${rules} \
    --category ${category} \
    --output ${table_pos}
