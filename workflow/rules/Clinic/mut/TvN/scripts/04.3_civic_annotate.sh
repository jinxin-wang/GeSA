...
python -u workflow/rules/Clinic/Mut_Annotation/TvN/scripts/04.1_civic_preprocess.py \
    --table_alt ${table_alt} \
    --table_cln ${table_cln} \
    --table_gen ${table_gen} \
    --gen_gene_name name \
...
python -u workflow/rules/Clinic/Mut_Annotation/TvN/scripts/04.2_civic_postprocess.py \
    --input ${table_run} \
    --output ${table_pos}
