...
if "resources" in job_properties:
    ...
    if arg_dict["partition"] is None:
        if "queue" in job_properties["params"]:
            arg_dict["partition"] = job_properties["params"]["queue"]
        elif "partition" in job_properties["resources"]:
            arg_dict["partition"] = job_properties["resources"]["partition"]
    ...
    if arg_dict["time"] is None:
        ...
        elif arg_dict["partition"] is not None and arg_dict["partition"] == "shortq":
            arg_dict["time"] = 360 
        elif arg_dict["partition"] is not None and arg_dict["partition"] == "mediumq":
            arg_dict["time"] = 1440
        elif arg_dict["partition"] is not None and arg_dict["partition"] == "longq":
            arg_dict["time"] = 10080
        elif arg_dict["partition"] is not None and arg_dict["partition"] == "verylongq":
            arg_dict["time"] = 86400
    ...
    if arg_dict["partition"] is None:
        if "time" in arg_dict.keys() and arg_dict["time"] < 360:
            arg_dict["partition"] = "shortq"
        elif "time" in arg_dict.keys() and 360 <= arg_dict["time"] < 1440:
            arg_dict["partition"] = "mediumq"
        elif "time" in arg_dict.keys() and 1440 <= arg_dict["time"] < 10080:
            arg_dict["partition"] = "longq"
        elif "time" in arg_dict.keys() and 10080 <= arg_dict["time"] < 86400:
